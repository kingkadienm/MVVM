...
public class EasyPermissionsEx {
    ...
    public static boolean hasPermissions(Context context, String... perms) {
        if (context == null) {
            LogUtil.e(TAG, "hasPermissions method context is null");
            return true;
        }
    ...
    public static void requestPermissions(final Object object, String rationale,
        ...
        if (object == null) {
            LogUtil.e(TAG, "requestPermissions method object is null");
            return;
        }
        Context ctx;
        ...
        if (shouldShowRationale) {
           /* Activity activity = getActivity(object);
            ...
            CommonAlertDialog dialog = new CommonAlertDialog(ctx).builder()
                    .setTitle(ctx.getResources().getString(R.string.app_tip))
                    .setMsg(rationale)
                    .setPositiveButton(ctx.getResources().getString(R.string.app_ok), v -> {
                        executePermissionsRequest(object, perms, requestCode);

                    })
                    .setNegativeButton(ctx.getResources().getString(R.string.app_cancel), v -> {
    ...
    public static void goSettings2Permissions(final Object object, String rationale, String snackbarAction, final int requestCode) {
        ...
        CommonAlertDialog dialog = new CommonAlertDialog(ctx).builder()
                .setTitle(ctx.getResources().getString(R.string.app_tip))
                .setMsg(rationale)
                .setPositiveButton(snackbarAction, v -> {
        ...
        if (!(isSupportFragment || isActivity || (isAppFragment && isMinSdkM))) {
            if (isAppFragment) {
                throw new IllegalArgumentException(
                        "Target SDK needs to be greater than 23 if caller is Fragment");
            } else {
