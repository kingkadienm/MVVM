...
import com.wangzs.lib.net.error.INTERNAL_SERVER_ERROR
import com.wangzs.lib.net.error.NETWORK_ERROR
import com.wangzs.lib.net.error.NOT_FOUND
import com.wangzs.lib.net.error.NOT_NETWORK
import com.wangzs.lib.net.error.REQUEST_TIMEOUT
import com.wangzs.lib.net.error.SERVICE_UNAVAILABLE
import com.wangzs.lib.net.error.SUCCESS
import com.wangzs.lib.net.error.UNAUTHORIZED
import com.wangzs.lib.net.error.mapper.ErrorManager
import com.wangzs.lib.net.error.mapper.ErrorMapper
import com.wangzs.lib.net.utils.NetworkConnectivity
import com.wangzs.lib.net.utils.NetworkHelper
...
abstract class AbsRemoteDataSource {
     ...
     * 不处理返回体
     */
    protected fun <T> convertResponse(response: Response<T>): Response<T> {
        return response;
    }
